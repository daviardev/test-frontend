  ...
  return (
    <Modal>
      <header className='flex items-center mb-6'>
        ...
        />
        <h1 className='text-title font-extrabold text-3xl'>New Provider</h1>
      </header>
      ...
      <section>
        <div className='grid grid-cols-1 sm:grid-cols-12 gap-4'>
          ...
          <div className='sm:col-span-6'>
            <Input label='Name' type='number' className='w-full' />
          </div>
          <div className='sm:col-span-6'>
          ...
          <div className='sm:col-span-12'>
            <Input label='Website' className='w-full' />
          </div>
        </div>
      </section>

      <section className='flex justify-between items-center space-x-4 mt-6'>
        <button className='bg-button text-white px-6 py-2 w-full sm:w-auto'>Providers</button>
